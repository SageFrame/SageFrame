        ...
        <div class="sfFormwrapper">
            <div class="sfUserRegistrationInfoLeft" id="divRegister" runat="server">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td colspan="2">
                            <span class="sfAllrequired">* All Fields are compulsory. </span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="FirstNameLabel" runat="server" AssociatedControlID="FirstName" 
                                CssClass="sfFormlabel" meta:resourcekey="FirstNameLabelResource1">First Name: </asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="FirstName" CssClass="sfInputbox" autofocus="autofocus" 
                                runat="server" meta:resourcekey="FirstNameResource1"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="FirstName"
                                Display="Dynamic" ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                CssClass="sfError" meta:resourcekey="rfvFirstNameResource1"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="LastNameLabel" runat="server" AssociatedControlID="LastName" 
                                CssClass="sfFormlabel" meta:resourcekey="LastNameLabelResource1">Last Name:</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="LastName" CssClass="sfInputbox" autofocus="autofocus" 
                                runat="server" meta:resourcekey="LastNameResource1"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvLastName" runat="server" ControlToValidate="LastName"
                                Display="Dynamic" ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                CssClass="sfError" meta:resourcekey="rfvLastNameResource1"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" 
                                CssClass="sfFormlabel" meta:resourcekey="UserNameLabelResource1">User Name:</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="UserName" MaxLength="256" runat="server" CssClass="sfInputbox" 
                                autofocus="autofocus" meta:resourcekey="UserNameResource1"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvUserNameRequired" runat="server" ControlToValidate="UserName"
                                Display="Dynamic" ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                CssClass="sfError" meta:resourcekey="rfvUserNameRequiredResource1"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="Email" 
                                CssClass="sfFormlabel" meta:resourcekey="EmailLabelResource1">E-mail:</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="Email" MaxLength="256" runat="server" CssClass="sfInputbox" 
                            ...
                            <asp:RequiredFieldValidator ID="rfvEmailRequired" runat="server" ControlToValidate="Email"
                                Display="Dynamic" ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                CssClass="sfError" meta:resourcekey="rfvEmailRequiredResource1"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="Email"
                                ...
                                CssClass="sfError" meta:resourcekey="revEmailResource1"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password" 
                                CssClass="sfFormlabel" meta:resourcekey="PasswordLabelResource1">Password:</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="Password" MaxLength="20" runat="server" TextMode="Password" 
                                CssClass="sfInputbox password" meta:resourcekey="PasswordResource1"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvPasswordRequired" runat="server" ControlToValidate="Password"
                                Display="Dynamic" ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                CssClass="sfError" meta:resourcekey="rfvPasswordRequiredResource1"></asp:RequiredFieldValidator>
                            <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Display="Dynamic" runat="server" ErrorMessage="Password must be atleast of 4 character.."
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvConfirmPasswordRequired" runat="server" ControlToValidate="ConfirmPassword"
                                Display="Dynamic" ErrorMessage="*" ValidationGroup="CreateUserWizard1" 
                                CssClass="sfError" meta:resourcekey="rfvConfirmPasswordRequiredResource1"></asp:RequiredFieldValidator>
                    ...
                    <tr runat="server" id="captchaTR">
                        ...
                        <td class="sfCatpchatd">
                            ...
                            <asp:Image ID="CaptchaImage" runat="server" CssClass="sfCaptcha" 
                                meta:resourcekey="CaptchaImageResource1" /><br />
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="DataLabel" runat="server" Text="Enter Data Shown Left:" AssociatedControlID="CaptchaValue"
                        ...
                        <td>
                            <div class="sfButtonwrapper">
                                <asp:Button ID="FinishButton" runat="server" AlternateText="Finish"
                                    ValidationGroup="CreateUserWizard1" CommandName="MoveComplete" CssClass="sfBtn"
                                    Text="Register" OnClick="FinishButton_Click" 
            ...
            <div id="divRegistration" runat="server">
                ...
                <div id="divRegConfirm" class="sfRegConfirm" runat="server">
                    ...
                    <asp:Label ID="lblRegSuccess" runat="server" CssClass="sfFormlabel" 
                        meta:resourcekey="lblRegSuccessResource1">
