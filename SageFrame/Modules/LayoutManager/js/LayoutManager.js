        ...
        var LayoutManager = {
            ...
            ajaxSuccess: function(data) {
                switch (LayoutManager.config.ajaxCallMode) {
                    case 0:
                        //LayoutManager.BindLayout(data);
                        // $('#txtLayoutEditor').val(data.d);                        
            ...
            BindEvents: function() {
                ...
                function RemoveVisible(filepath, attrName) {
                    $.ajax({
                        type: "POST",
                        url: '/SageFrame/Modules/LayoutManager/WebMethod.aspx/RemoveVisible',
                ...
                function setXml(filepath) {
                    $.ajax({
                        type: "POST",
                        url: '/SageFrame/Modules/LayoutManager/WebMethod.aspx/setXml',
                ...
                function RewriteWireFrame(filepath, attrName) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '/SageFrame/Modules/LayoutManager/WebMethod.aspx/RewriteWireFrame',
                        data: JSON.stringify({ FilePath: filepath, attrName: attrName }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function(msg) {
                ...
                $('#imgAddPlaceHolder').toggle(function() {
                    ...
                    $('#imgAddPlaceHolder').attr("src", "/SageFrame/Modules/LayoutManager/images/allow_list_close.jpg");
                }, function() {
                    $('#txtLayoutEditor').removeClass("layoutEditorWithPch").addClass("layoutEditor");
                    $('#tblPch').hide();
                    $('#imgAddPlaceHolder').attr("src", "/SageFrame/Modules/LayoutManager/images/text_code_add.png");
                });
            ...
            ShowPopUp: function(popupid, headertext) {
                ...
                //SageFrame.popup.show_wide(popupid,headertext);
                var options = {
                    modal: true,
                    title: headertext,
                    height: 550,
            ...
            ReadBlockHTML: function(fileName) {
                ...
                this.config.url = this.config.baseURL + this.config.method;
                this.config.data = JSON2.stringify({ fileName: "/SageFrame/Modules/LayoutManager/Sections/" + fileName });
                this.config.ajaxCallMode = 5;
                this.ajaxCall(this.config);
            },
            BindBlockHTML: function(data) {
                //$('#txtHTMLEditor').ckeditor("config");
                var html = data.d;
            ...
            BindTemplates: function(data) {
                ...
                $.each(template, function(index, item) {
                    ...
                    var editFileLink = SageFrameAppPath + "/Admin/Template-File-Editor.aspx?tname=" + item.TemplateSeoName + "";
                    if (!item.IsDefault) {
